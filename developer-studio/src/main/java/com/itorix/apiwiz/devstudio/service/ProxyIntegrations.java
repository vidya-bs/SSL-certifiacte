...
public interface ProxyIntegrations {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/v1/integrations/azure", produces = {"application/json"})
	public ResponseEntity<?> getAzureIntegraton(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid) throws Exception;

	@RequestMapping(method = RequestMethod.PUT, value = "/v1/integrations/azure", produces = {"application/json"})
	public ResponseEntity<?> createupdateAzureIntegraton(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid, @RequestBody GitIntegration gitIntegration)
			throws Exception;

	@RequestMapping(method = RequestMethod.DELETE, value = "/v1/integrations/azure/{id}", produces = {
			"application/json"})
