...
public interface ProxyIntegrations {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/v1/integrations/github", produces = {
	"application/json" })
	public ResponseEntity<?> getGitIntegraton(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid)throws Exception ;
	
	@RequestMapping(method = RequestMethod.PUT, value = "/v1/integrations/github", produces = {
	"application/json" })
	public ResponseEntity<?> createupdateGitIntegraton(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid,
			@RequestBody GitIntegration gitIntegration)throws Exception ;
	...
	@RequestMapping(method = RequestMethod.GET, value = "/v1/integrations/jfrog", produces = {
	"application/json" })
	public ResponseEntity<?> getJfrogIntegraton(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid)throws Exception ;
	
	@RequestMapping(method = RequestMethod.PUT, value = "/v1/integrations/jfrog", produces = {
	"application/json" })
	public ResponseEntity<?> updateJfrogIntegraton(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid,
			@RequestBody JfrogIntegration jfrogIntegration)throws Exception ;
	...
	@RequestMapping(method = RequestMethod.GET, value = "/v1/integrations/gitlab", produces = {
	"application/json" })
	public ResponseEntity<?> getGitLabIntegraton(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid)throws Exception ;
	
	@RequestMapping(method = RequestMethod.PUT, value = "/v1/integrations/gitlab", produces = {
	"application/json" })
	...
	@RequestMapping(method = RequestMethod.GET, value = "/v1/integrations/bitbucket", produces = {
	"application/json" })
	public ResponseEntity<?> getBitBucketIntegraton(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid)throws Exception ;
	
	@RequestMapping(method = RequestMethod.PUT, value = "/v1/integrations/bitbucket", produces = {
	"application/json" })
	...
	@RequestMapping(method = RequestMethod.GET, value = "/v1/integrations/gocd", produces = {
	"application/json" })
	public ResponseEntity<?> getGocdIntegraton(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid)throws Exception ;
	
	@RequestMapping(method = RequestMethod.PUT, value = "/v1/integrations/gocd", produces = {
	"application/json" })
	public ResponseEntity<?> updateGocdIntegraton(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid,
			@RequestBody GoCDIntegration goCDIntegration)throws Exception;
