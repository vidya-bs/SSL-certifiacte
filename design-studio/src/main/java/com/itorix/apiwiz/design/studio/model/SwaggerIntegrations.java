...
//    @NotNull(message="scm_authorizationType cannot be missing or empty")
    ...
    {
        return "ClassPojo [scm_folder = "+scm_folder+", scm_url = "+scm_url+", scm_authorizationType = "+scm_authorizationType+", scm_branch = "+scm_branch+", scm_repository = "+scm_repository+", scm_username = "+scm_username+", scm_token = "+scm_token+", scm_type = "+scm_type+", scm_password = "+scm_password+"]";
    }
