...
public class XPathGen {
     ...
     * @Description : Method is used to
     */
    public void generateXPathForElement(final String fileName,final String elementname,final String outPutFileName) throws Exception {
        init(fileName);
        XmlSchemaElement elm = schema.getElementByName(elementname);
        if ( elm != null ) {
            buffer.append("Include| Element Path | Min | Max | XSD Type |JSON Type|JSON Format| Enum | Min Length | Max Length | Length | Pattern | Documentation").append("\n");
     ...
     * @Description : Method is used to
     */
    public void generateXPathForGroup(final String fileName,final String elementname,final String outPutFileName) throws Exception {
        init(fileName);
        ...
        if ( elm != null ) {
            ...
            XmlSchemaGroup xmlSchemaGroup = (XmlSchemaGroup)elm.getItem(new QName(schema.getTargetNamespace(),elementname));
    ...
    private void XPathForXMLSchemaElement(final XmlSchemaElement elm, String elementname) throws Exception {
        ...
        if ( st != null ) {
            ...
            if ( refName == null ) {
//                System.out.println("Review XSD Error with Elemnt: " + elementname + "/" + elm.getName());
            } else {
     ...
     * @Description : Method is used to
     */
    private XmlSchemaVo XPathForXMLSchemaSimpleType(final XmlSchemaSimpleType simpleType,XmlSchemaVo xmlSchemaVo) throws Exception {
    ...
    private void XPathForXMLSchemaComplexType(final XmlSchemaComplexType complexType,final String elementname,final XmlSchemaVo xmlSchemaVo) throws Exception {
     ...
     * @Description : Method is used to
     */
    private void XPathForXMLSchemaComplexType(final XmlSchemaComplexType complexType,final String elementname, boolean bNotARef,XmlSchemaVo xmlSchemaVo) throws Exception {
        ...
        if ( cc != null ) {
            if ( cc instanceof XmlSchemaComplexContent ) {
                ...
                if ( ext instanceof XmlSchemaComplexContentExtension ) {
                    XPathForXmlSchemaComplexContentExtension((XmlSchemaComplexContentExtension) ext, elementname,xmlSchemaVo);
                }
            }
     ...
     * @return
     * @Description : Method is used to wrap the documentation into single line.
     */
     ...
     * @Description : Method is used to
     */
    private void XPathForXmlSchemaSequence(final XmlSchemaSequence sequence,final String elementname) throws Exception {
     ...
     * @Description : Method is used to
     */
    private void XPathForXmlSchemaSimpleContent(final XmlSchemaSimpleContent simpleExtType,final String elementname, boolean bNotARef,XmlSchemaVo xmlSchemaVo)
            throws Exception {
    ...
    /**
     * 
     * Classname / Method Name : XPathGen/XPathForXmlSchemaComplexContentExtension()
     ...
     * @Description : Method is used to
     */
    private void XPathForXmlSchemaComplexContentExtension(final XmlSchemaComplexContentExtension complexExtType,final String elementname,final XmlSchemaVo xmlSchemaVo)
            throws Exception {
        // Handle base type
     ...
     * @param xmlSchemaVo
     * @return
     * @Description : Method is used to populate JSON Type and JSON Format values to XmlSchemaVo.
     */
