...
@XmlType(name = "ProxyStat", propOrder = {"name", "coverage", "totalPolicies", "executedPolicies", "stats"})
public class ProxyStat implements ToString {
	...
	public String toString() {
		 ...
		 * final StringBuilder buffer = new StringBuilder(); append(null,
		 * buffer, strategy); return buffer.toString();
		 */
