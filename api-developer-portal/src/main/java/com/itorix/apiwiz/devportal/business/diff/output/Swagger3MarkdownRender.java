...
import com.itorix.apiwiz.devportal.diff.v3.model.ElProperty;
import com.itorix.apiwiz.devportal.diff.v3.model.Endpoint;


public class Swagger3MarkdownRender implements Render {
	...
	final String LI = "* ";
	final String HR = "---\n";
	public ChangedOpenAPI diff;

	public Swagger3MarkdownRender() {}
	
	public Swagger3MarkdownRender(ChangedOpenAPI diff) {
		this.diff = diff;
	}

//	public String render1(SwaggerDiff diff) {
...
//
//		return renderHtml(diff.getSwaggerName(), diff.getSwaggerDescription(), diff.getOldVersion(), diff.getNewVersion(), ol_newEndpoint, ol_missingEndpoint, ol_changed);
//	}
	...
	public String renderHtml(String swaggerName, String swaggerDescription, String oldVersion, String newVersion, String ol_new, String ol_miss,
							 String ol_changed) {
