...
public class SoapArtifactServiceImpl implements SoapArtifactService {
	...
	public ResponseEntity<Object> getPostman(
		...
		return new ResponseEntity<Object>(
				soapArtifiactServiceDao.getPostMan(org, env, proxy, interactionid, type.toLowerCase(), isSaaS),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> updatePostman(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestParam(value = "orgId", required = false) String orgId, @RequestParam("file") MultipartFile file,
			@RequestParam("org") String org, @RequestParam("env") String env, @RequestParam("proxy") String proxy,
			@RequestParam("type") String type, @RequestHeader HttpHeaders headers,
			@RequestParam("isSaaS") boolean isSaaS, @RequestHeader(value = "JSESSIONID") String jsessionid,
	...
	public ResponseEntity<Object> getenv(@RequestHeader(value = "interactionid", required = false) String interactionid,
		...
		response.setHeader("JSESSIONID", jsessionid);
		return new ResponseEntity<Object>(
				soapArtifiactServiceDao.getEnvFile(org, env, proxy, interactionid, type.toLowerCase(), isSaaS),
				HttpStatus.OK);
	}
