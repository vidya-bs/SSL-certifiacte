...
@JsonPropertyOrder({"name", "fetch_materials", "clean_working_directory", "never_cleanup_artifacts", "approval",
		"environment_variables", "jobs"})
public class Stage {
	...
	public Stage(String name, boolean fetchMaterials, boolean cleanWorkingDirectory, boolean neverCleanupArtifacts,
		...
		authorization.setRoles(new ArrayList<Object>());
		authorization.setUsers(new ArrayList<Object>());
		approval.setAuthorization(authorization);
	}
