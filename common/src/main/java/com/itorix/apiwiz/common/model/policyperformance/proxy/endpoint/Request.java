...
public class Request implements ToString {

	@XmlElementRef(name = "Step", type = Step.class)
	...
	public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
		{
			List<Step> theContent;
			theContent = (((this.step != null) && (!this.step.isEmpty())) ? this.getStep() : null);
