...
public class KeyForADeveloperAppResponse {
	...
	public String toString() {
		return "ClassPojo [scopes = " + scopes + ", consumerKey = " + consumerKey + ", expiresAt = " + expiresAt
				+ ", status = " + status + ", issuedAt = " + issuedAt + ", attributes = " + attributes
				+ ", consumerSecret = " + consumerSecret + ", apiProducts = " + apiProducts + "]";
	}
}
