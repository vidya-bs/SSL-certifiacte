...
@XmlType(name = "", propOrder = {"condition", "step"})
@XmlRootElement(name = "FaultRule")
public class FaultRule implements ToString {

	@XmlElement(name = "Condition", required = true)
	protected String condition;

	@XmlElement(name = "Step", required = true, nillable = true)
