...
@XmlType(name = "", propOrder = {"basePath", "virtualHost"})
@XmlRootElement(name = "HTTPProxyConnection")
public class HTTPProxyConnection implements ToString {
	...
	public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
		...
		}
		{
			...
			theVirtualHost = (((this.virtualHost != null) && (!this.virtualHost.isEmpty()))
					? this.getVirtualHost()
					: null);
