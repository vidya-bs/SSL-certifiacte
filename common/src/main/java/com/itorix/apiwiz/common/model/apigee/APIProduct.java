...
public class APIProduct
{
    ...
    {
        return "ClassPojo [apiResources = "+apiResources+", quotaTimeUnit = "+quotaTimeUnit+", environments = "+environments+", scopes = "+scopes+", quota = "+quota+", createdBy = "+createdBy+", createdAt = "+createdAt+", description = "+description+", name = "+name+", lastModifiedBy = "+lastModifiedBy+", quotaInterval = "+quotaInterval+", attributes = "+attributes+", displayName = "+displayName+", approvalType = "+approvalType+", proxies = "+proxies+", lastModifiedAt = "+lastModifiedAt+"]";
    }
}
