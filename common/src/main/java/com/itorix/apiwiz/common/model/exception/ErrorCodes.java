	...
	public static final Map<String, String> errorMessage = new HashMap<String, String>() {
...

		{
			...
			put("Configuration-1016",
					"Request validation failed. Request validation failed. KVM name %KVMName for Org %orgname and Env %env already exists.");
			...
			put("Identity-1003",
					"Sorry! Invalid login session, the session you are using got expired, relogin to continue.");
			put("Identity-1004",
