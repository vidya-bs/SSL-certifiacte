...
public enum ErrorCodes {
	...
	public static final Map<String, String> errorMessage = new HashMap<String, String>() {
...

		{
			...
			put("CodeCoverage-1001" , "Request validation failed. Please check the mandatory data fields and retry again.");
			put("PolicyPerformance-1000" , "Resource not found. Please check the request and retry again.");
			put("PolicyPerformance-1001" , "Request validation failed. Please check the mandatory data fields and retry again.");
