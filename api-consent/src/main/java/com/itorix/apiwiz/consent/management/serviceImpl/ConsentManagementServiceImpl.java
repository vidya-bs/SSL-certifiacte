...
public class ConsentManagementServiceImpl implements ConsentManagementService {
	...
	public ResponseEntity<?> getScopeCategories(Map<String, String> searchParams) throws ItorixException {
		return new ResponseEntity<>(consentManagementDao.getScopeCategories(getOffset(searchParams),
				getPageSize(searchParams), searchParams), HttpStatus.OK);
	}
	...
	@Override
	public ResponseEntity<?> getConsentsOverview(String jsessionid, Map<String, String> searchParams)
			throws ItorixException {
		return new ResponseEntity<>(consentManagementDao.getConsentsOverview(getOffset(searchParams),
				getPageSize(searchParams), searchParams), HttpStatus.OK);
	}
	...
	@Override
	public ResponseEntity<?> generateExcelReport(String interactionId, String jsessionid, String timeRange)
			throws Exception {
