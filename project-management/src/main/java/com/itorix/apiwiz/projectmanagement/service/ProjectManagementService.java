...
public interface ProjectManagementService {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/v1/projects/{projectName:.+}", produces = {
			"application/json"})
	...
	public ResponseEntity<?> getWSDLDocument(
			...
			@PathVariable("proxyName") String proxyName, @PathVariable("fileName") String fileName) throws Exception;
	...
	@RequestMapping(method = RequestMethod.GET, value = {
			"/v1/projects/{projectName:.+}/proxies/{proxyName:.+}/service-registry/{serviceName}",
	...
	public ResponseEntity<?> createServiceRegistry(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid, @PathVariable("projectName") String projectName,
			@PathVariable("proxyName") String proxyName, @RequestBody ServiceRegistry serviceRegistry) throws Exception;
