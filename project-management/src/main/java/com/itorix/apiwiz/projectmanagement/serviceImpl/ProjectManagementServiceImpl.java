...
public class ProjectManagementServiceImpl implements ProjectManagementService {
	...
	public ResponseEntity<Object> createNewProject(
		...
		return new ResponseEntity<Object>(projectManagementDao.createNewProject(project, jsessionid),
				HttpStatus.CREATED);
	}
	...
	public ResponseEntity<Object> getParticularProject(
			...
			@RequestHeader(value = "JSESSIONID") String jsessionid) throws ItorixException {
		return new ResponseEntity<Object>(projectManagementDao.findProjectByName(projectName), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getOrganistaionsForProject(
			...
			@PathVariable("projectName") String projectName, @RequestHeader HttpHeaders headers,
			@RequestHeader(value = "JSESSIONID") String jsessionid) throws ItorixException {
		return new ResponseEntity<Object>(projectManagementDao.findOrganistionsOfProject(projectName), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getOrganistaionsForProxyForProject(
		...
		return new ResponseEntity<Object>(
				projectManagementDao.findOrganistionsOfProxyOfProject(projectName, proxiesName), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getProxiesForProject(
			...
			@PathVariable("projectName") String projectName, @RequestHeader HttpHeaders headers,
			@RequestHeader(value = "JSESSIONID") String jsessionid) throws ItorixException {
		return new ResponseEntity<Object>(projectManagementDao.findProxiesForProject(projectName), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getProductsForProject(
			...
			@PathVariable("projectName") String projectName, @RequestHeader HttpHeaders headers,
			@RequestHeader(value = "JSESSIONID") String jsessionid) throws ItorixException {
		return new ResponseEntity<Object>(projectManagementDao.findProductsForProject(projectName), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getProductsForProxyForProject(
			...
			@RequestHeader HttpHeaders headers, @RequestHeader(value = "JSESSIONID") String jsessionid)
			throws ItorixException {
		return new ResponseEntity<Object>(projectManagementDao.findProductsForProxyForProject(projectName, proxiesName),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getAppsForProject(
			...
			@PathVariable("projectName") String projectName, @RequestHeader HttpHeaders headers,
			@RequestHeader(value = "JSESSIONID") String jsessionid) throws ItorixException {
		return new ResponseEntity<Object>(projectManagementDao.findAppsForProject(projectName), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getStatusOfProject(
			...
			@PathVariable("projectName") String projectName, @RequestHeader HttpHeaders headers,
			@RequestHeader(value = "JSESSIONID") String jsessionid) throws ItorixException {
		return new ResponseEntity<Object>(projectManagementDao.findStatusOfProject(projectName), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getContactsOfProject(
			...
			@PathVariable("projectName") String projectName, @RequestHeader HttpHeaders headers,
			@RequestHeader(value = "JSESSIONID") String jsessionid) throws ItorixException {
		return new ResponseEntity<Object>(projectManagementDao.findContactsOfProject(projectName), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getAppsForProxyForProject(
			...
			@RequestHeader HttpHeaders headers, @RequestHeader(value = "JSESSIONID") String jsessionid)
			throws ItorixException {
		return new ResponseEntity<Object>(projectManagementDao.findAppsForProxyForProject(projectName, proxiesName),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> deleteProject(
			...
			@PathVariable("projectName") String projectName, @RequestHeader HttpHeaders headers,
			@RequestHeader(value = "JSESSIONID") String jsessionid) throws ItorixException {
		return new ResponseEntity<Object>(projectManagementDao.deleteProject(projectName, jsessionid),
				HttpStatus.NO_CONTENT);
	}
	...
	public ResponseEntity<Object> getProjectStats(
		...
		return new ResponseEntity<Object>(projectManagementDao.getProjectStats(timeunit, timerange), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> uploadProxyDocument(
			...
			@RequestParam(value = "type") String type, @PathVariable("projectName") String projectName,
		...
		return new ResponseEntity<Object>(projectManagementDao.uploadProjectFile(file, projectFile), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> getWSDLDocument(
			...
			@PathVariable("projectName") String projectName, @PathVariable("proxyName") String proxyName,
		...
		return ResponseEntity.ok().header(HttpHeaders.CONTENT_DISPOSITION, "attachment;filename=" + fileName)
				.contentLength(data.getBytes().length).contentType(MediaType.parseMediaType("application/octet-stream"))
				.body(resource);
	}
	...
	public ResponseEntity<?> createProjectProxyConnections(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID", required = false) String jsessionid,
			@PathVariable("proxyName") String proxyName, @PathVariable("projectName") String projectName,
	...
	public ResponseEntity<?> getServiceRegistry(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid, @PathVariable("projectName") String projectName,
		...
		if (serviceName != null && serviceName != "")
			return new ResponseEntity<Object>(
					projectManagementDao.getServiceRegistry(projectName, proxyName, serviceName), HttpStatus.OK);
		else
	...
	public ResponseEntity<?> createServiceRegistry(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid, @PathVariable("projectName") String projectName,
			@PathVariable("proxyName") String proxyName, @RequestBody ServiceRegistry serviceRegistry)
			throws Exception {
	...
	public ResponseEntity<?> updateServiceRegistry(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid, @PathVariable("projectName") String projectName,
			@PathVariable("proxyName") String proxyName, @PathVariable("serviceName") String serviceName,
	...
	public ResponseEntity<?> importData(@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid, @RequestParam("file") MultipartFile file)
			throws Exception {
		return new ResponseEntity<Object>(projectManagementDao.loadExcelData(file, jsessionid), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> promoteToMaster(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid, @PathVariable("projectName") String projectName,
			@PathVariable("proxyName") String proxyName, @RequestBody ScmPromote scmPromote) throws Exception {
	...
	public ResponseEntity<?> publishEndpoint(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID") String jsessionid, @PathVariable("projectName") String projectName,
			@PathVariable("proxyName") String proxyName, @PathVariable("registryName") String registryName,
