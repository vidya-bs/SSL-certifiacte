package com.itorix.apiwiz.identitymanagement.model.sso;
...
/**
 * The following configuration is used to store saml response data node name
 * details.
 *
 * @author kishan
 *
...
public class SAMLConfig {
	...
	// metadata file of the idp, either metadataUrl or metadata should be
	// provided
