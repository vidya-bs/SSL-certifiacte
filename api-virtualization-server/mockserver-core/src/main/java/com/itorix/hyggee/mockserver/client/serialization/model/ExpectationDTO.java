...
public class ExpectationDTO extends ObjectWithJsonToString implements DTO<Expectation> {
    ...
    private com.itorix.hyggee.mockserver.client.serialization.model.TimesDTO times;
    ...
    public ExpectationDTO(Expectation expectation) {
        if (expectation != null) {
            ...
            if (times != null) {
                this.times = new com.itorix.hyggee.mockserver.client.serialization.model.TimesDTO(times);
            }
    ...
    public com.itorix.hyggee.mockserver.client.serialization.model.TimesDTO getTimes() {
        return times;
    }

    public ExpectationDTO setTimes(com.itorix.hyggee.mockserver.client.serialization.model.TimesDTO times) {
        this.times = times;
        return this;
    }
