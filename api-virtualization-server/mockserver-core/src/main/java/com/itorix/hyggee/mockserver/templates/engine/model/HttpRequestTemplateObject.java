package com.itorix.hyggee.mockserver.templates.engine.model;

import com.google.common.base.Function;
import com.google.common.collect.Lists;
import com.itorix.hyggee.mockserver.client.serialization.model.BodyDTO;
...
public class HttpRequestTemplateObject extends ObjectWithJsonToString {
    ...
    public HttpRequestTemplateObject(HttpRequest httpRequest, boolean escape) {
    	new HttpRequestTemplateObject(httpRequest);
    	if(escape) {
    	}
    }
