...
public class MockServerResponseEncoder extends MessageToMessageEncoder<HttpResponse> {
    ...
    private void setCookies(HttpResponse response, DefaultFullHttpResponse fullHttpResponse) {
        if (response.getCookieList() != null) {
            ...
            for (com.itorix.hyggee.mockserver.model.Cookie cookie : response.getCookieList()) {
    ...
    private boolean cookieHeaderAlreadyExists(HttpResponse response, com.itorix.hyggee.mockserver.model.Cookie cookieValue) {
