...
import static com.itorix.hyggee.mockserver.model.HttpStatusCode.NOT_FOUND_404;
import static com.itorix.hyggee.mockserver.model.HttpStatusCode.OK_200;
...
public class HttpResponse extends Action {
    ...
    public static HttpResponse notFoundResponse(String body) {
        return new HttpResponse().withStatusCode(NOT_FOUND_404.code()).withReasonPhrase(NOT_FOUND_404.reasonPhrase()).withBody(body);
    }
