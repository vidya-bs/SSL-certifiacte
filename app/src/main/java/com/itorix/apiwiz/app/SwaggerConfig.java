...
public class SwaggerConfig {
	...
	public GroupedOpenApi pipelinesApi() {
		return GroupedOpenApi.builder()
				.group("pipelines")
				.pathsToMatch("/v1/pipelines/**")
				.build();
	}
	@Bean
	public GroupedOpenApi packagesApi() {
		return GroupedOpenApi.builder()
				.group("pipelinepackages")
				.pathsToMatch("/v1/packages/**")
				.build();
	}
	@Bean
	...
	public GroupedOpenApi dataDictionaryApi() {
		return GroupedOpenApi.builder()
				...
				.pathsToMatch("/v1/data-dictionary/**")
				.build();
	}
	@Bean
	...
	public GroupedOpenApi serviceRegistryApi() {
		return GroupedOpenApi.builder()
				...
				.pathsToMatch("/v1/service-registry/**")
				.build();
	}
}
