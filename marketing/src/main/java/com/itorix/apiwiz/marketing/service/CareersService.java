...
public interface CareersService {
	...
	public ResponseEntity<?> createJobPosting(
			...
			@RequestHeader(value = "x-apikey") String apikey, @RequestBody JobPosting jobPosting) throws Exception;
	...
	public ResponseEntity<?> updateJobPosting(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID", required = false) String jsessionid,
			@RequestHeader(value = "x-apikey") String apikey, @PathVariable("jobId") String jobId,
	...
	public ResponseEntity<?> deleteJobPosting(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID", required = false) String jsessionid,
			@RequestHeader(value = "x-apikey") String apikey, @PathVariable("jobId") String jobId) throws Exception;
	...
	public ResponseEntity<?> getJobPosting(
			@RequestHeader(value = "interactionid", required = false) String interactionid,
			@RequestHeader(value = "JSESSIONID", required = false) String jsessionid,
			@RequestHeader(value = "x-apikey", required = false) String apikey, @PathVariable("jobId") String jobId)
			throws Exception;
